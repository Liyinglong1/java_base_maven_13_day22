...
public class ExcelUtils {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * ExcelUtils.class.getResourceAsStream("/case17/test_case_01.xlsx");; Workbook
		 * workbook = WorkbookFactory.create(inputStream);
		 * //在第1个表单的第一行的第一列写入：Java13期的同学们大家好 Sheet sheet = workbook.getSheetAt(0); Row
		 * firstRow = sheet.getRow(0); Cell cell = firstRow.getCell(0,
		 * MissingCellPolicy.CREATE_NULL_AS_BLANK); cell.setCellType(CellType.STRING);
		 * //修改cell的值 cell.setCellValue("Java13期的同学们大家好");
		 * 
		 * OutputStream outputStream = new FileOutputStream(new
		 * File("D:\\test_case_01.xlsx")); workbook.write(outputStream);
		 * 
		 * outputStream.close(); workbook.close(); inputStream.close();
		 */

	}

	public static void writeExcel(String sourceExcelPath, String targetExcelPath, int sheetIndex, CellData cellData)
			throws Exception {
